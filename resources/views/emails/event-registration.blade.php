<x-mail::message>
  ...
  **Teilnahme:** {{ $event->cost_basis }}
  ...
  [hallo@mens-circle.de](mailto:hallo@mens-circle.de?subject=Frage%20zur%20Anmeldung)
  --- Wir freuen uns auf dich. Herzliche Grüße,<br />
  **{{ config('app.name') }}**

  <x-mail::subcopy>
    Diese E-Mail wurde an {{ $registration->participant->email }} gesendet, weil
    du dich für unsere Veranstaltung angemeldet hast.
  </x-mail::subcopy>

  <x-analytics.email-pixel
    :subscriptionId="$registration->id"
    eventName="event_registration_open"
  />
</x-mail::message>
