<x-mail::message>
  ...
  ## Was jetzt? Wir informieren dich automatisch per E-Mail, sobald ein Platz
  frei wird. Du musst nichts weiter tun. Solltest du doch nicht mehr teilnehmen
  können, schreib uns kurz an
  [hallo@mens-circle.de](mailto:hallo@mens-circle.de), damit wir deinen Platz
  weitergeben können. --- Wir freuen uns, dich vielleicht bald begrüßen zu
  dürfen. Herzliche Grüße,<br />
  **{{ config('app.name') }}**

  <x-mail::subcopy>
    Diese E-Mail wurde an {{ $registration->participant->email }} gesendet, weil
    du dich auf die Warteliste für unsere Veranstaltung eingetragen hast.
  </x-mail::subcopy>
</x-mail::message>
