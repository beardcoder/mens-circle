    ...
    <div class="container">
        <div class="whatsapp__layout fade-in">
            ...
            <div class="whatsapp__action">
                <a href="{{ $settings->whatsapp_community_link }}" target="_blank" rel="noopener noreferrer" class="whatsapp__button" data-m:click="action=cta_click;element=button;target=whatsapp_community;location=community_section">
