...
>
  <div class="container">
    <div class="section-header">
      <p class="eyebrow animate-fade-down">Community Stimmen</p>
      <h2 class="section-title animate-fade-up" id="testimonials-title">
        Was <span class="highlight">Teilnehmer</span> sagen
      </h2>
      <p class="testimonials__subtitle animate-fade-up">
        Authentische Einblicke von Männern, die den Kreis erleben
      </p>
    </div>

    <div class="testimonials__grid animate-fade-up">
