    ...
    <div class="container--narrow container">
      <div class="error-page">
        <div class="error-page__content">
          ...
          <p class="error-page__text">Es ist ein unerwarteter Fehler aufgetreten. Wir arbeiten bereits an einer Lösung.<br />
          Bitte versuche es in wenigen Minuten erneut.</p>
