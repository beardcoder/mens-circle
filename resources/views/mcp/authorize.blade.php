      ...
      <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
        ...
        <div class="flex flex-col space-y-1.5 p-6">
          <div class="flex items-center justify-center mb-4">
            <!-- Shield Icon -->
            <svg class="h-12 w-12 text-primary" width="48" height="48" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <p class="text-sm text-muted-foreground text-center">This application will be able to:<br />Use available MCP functionality.</p>
        </div>
        ...
        <div class="flex items-center p-6 pt-0 gap-3">
          ...
          >
            ...
            >
              <svg class="mr-2 h-4 w-4" width="16" height="16" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          >
            ...
            >
              ...
              <svg id="loadingSpinner" class="animate-spin -ml-1 mr-3 h-4 w-4 text-white hidden" width="16" height="16" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      const cancelForm = document.querySelector(
        'form[method="POST"]:has(input[name="_method"][value="DELETE"])'
      );
      if (cancelForm) {
