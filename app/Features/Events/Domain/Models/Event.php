...
namespace App\Features\Events\Domain\Models;
...
class Event extends Model implements HasMedia
{
    ...
    public function sendRegistrationConfirmation(Registration $registration, EventNotificationService $notificationService): void
    {
        $notificationService->sendRegistrationConfirmation($this, $registration);
    }

    public function sendEventReminder(Registration $registration, EventNotificationService $notificationService): void
    {
        $notificationService->sendEventReminder($this, $registration);
    }
