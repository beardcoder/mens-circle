...
final readonly class LocalBusinessSchema
{
    ...
    public function toScript(): string
    {
        ...
        $schema = Schema::localBusiness()
            ...
            ->address(
                Schema::postalAddress()->addressLocality('Straubing')->addressRegion('Bayern')->postalCode('94315')->addressCountry('DE'),
            )
            ->geo(Schema::geoCoordinates()->latitude(48.8777)->longitude(12.5731))
            ->areaServed(
                Schema::geoCircle()->geoMidpoint(Schema::geoCoordinates()->latitude(48.8777)->longitude(12.5731))->geoRadius('50000'),
            )
            ->priceRange('€')
